...
public class RecommendFragment extends Fragment {
    ...
    private void initViewPager() {
        ...
        fragmentList.add(new RecommendPolicyBulletin());
        ...
        tabLayout.addTab(tabLayout.newTab().setText("비즈인포"));
        tabLayout.addTab(tabLayout.newTab().setText("드림365"));
        tabLayout.addTab(tabLayout.newTab().setText("판로지원"));

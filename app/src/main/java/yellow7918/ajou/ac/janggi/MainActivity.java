...
public class MainActivity extends AppCompatActivity {
    ...
    private void alarm() {
        ...
        builder.setSmallIcon(R.drawable.logo).setTicker("장기알 알림").setWhen(System.currentTimeMillis())
                .setNumber(1).setContentTitle("장기알 맞춤공고 알림").setContentText("새로운 맞춤공고가 도착했습니다")
